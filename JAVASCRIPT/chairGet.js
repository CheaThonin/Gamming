...
const Row = document.getElementById("GamingChair");
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        if (product) {
          ...
          document.getElementById("modalSpecs").innerText = product.description; // Assuming 'specs' is the field for specifications
