const url = "../DATA/asusData.json";
const Row = document.getElementById("AsusBrand");
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      if (product) {
        ...
        document.getElementById("modalDescription").innerText = product.detail; // Assuming 'detail' is the description field
